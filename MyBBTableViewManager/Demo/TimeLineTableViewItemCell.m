...
- (void)initCell {
    ...
    _timeNode.style.flexShrink = YES; //if name and username don't fit to cell width, allow username shrink
    ...
    _fromNode.attributedText = [[NSAttributedString alloc] initWithString:@"来自iPhone 6S Plus"
                                                                 attributes:[TextStyles usernameStyle]];
    _fromNode.style.flexShrink = YES; //if name and username don't fit to cell width, allow username shrink
    ...
    _avatarNode.style.preferredSize = CGSizeMake(44, 44);
