...
@interface BBTableViewManager : NSObject  <UITableViewDelegate, UITableViewDataSource>
 ...
 */
@property (weak, readwrite, nonatomic) id<BBTableViewManagerDelegate> delegate;
 ...
 */
@protocol BBTableViewManagerDelegate <UITableViewDelegate>
