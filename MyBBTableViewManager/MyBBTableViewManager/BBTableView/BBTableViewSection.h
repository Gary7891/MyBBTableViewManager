...
@class BBTableViewCellStyle;

extern CGFloat const BBTableViewSectionHeaderHeightAutomatic;
extern CGFloat const BBTableViewSectionFooterHeightAutomatic;
...
///-----------------------------
/// @name Creating and Initializing a BBTableViewSection
///-----------------------------
